...
const cvFormatter = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    (arr[i].yearsOfExperience > 1) && (arr[i].firstName !== null) && (arr[i].lastName !== null) ? result.push({fullName: `${arr[i].firstName} ${arr[i].lastName}`, tech: `${arr[i].tech}`}) :
          (arr[i].yearsOfExperience > 1) && (arr[i].firstName !== null) && (arr[i].lastName === null) ? result.push({fullName: `${arr[i].firstName}`, tech: `${arr[i].tech}`}) :
              (arr[i].yearsOfExperience > 1) && (arr[i].firstName === null) && (arr[i].lastName !== null) ? result.push({fullName: `${arr[i].lastName}`, tech: `${arr[i].tech}`}) : "";
